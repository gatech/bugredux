...
entry:
  ...
  call void @klee_make_symbolic(i8* %x1, i32 4, i8* %name) nounwind, !dbg !0
  %0 = load i32* %x, align 4, !dbg !10            ; <i32> [#uses=1]
  ret i32 %0, !dbg !10
}
...
!2 = metadata !{i32 458798, i32 0, metadata !3, metadata !"klee_int", metadata !"klee_int", metadata !"klee_int", metadata !3, i32 13, metadata !4, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!3 = metadata !{i32 458769, i32 0, i32 1, metadata !"klee_int.c", metadata !"/home/wei/Documents/code/klee2.7/klee/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!10 = metadata !{i32 16, i32 0, metadata !1, null}
