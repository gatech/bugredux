...
entry:
  %0 = tail call i32 @strcmp(i8* %s1, i8* %s2) nounwind readonly, !dbg !0 ; <i32> [#uses=1]
  ret i32 %0, !dbg !0
}
...
!2 = metadata !{i32 458798, i32 0, metadata !3, metadata !"strcoll", metadata !"strcoll", metadata !"strcoll", metadata !3, i32 13, metadata !4, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!3 = metadata !{i32 458769, i32 0, i32 1, metadata !"strcoll.c", metadata !"/home/wei/Documents/code/klee2.7/klee/runtime/klee-libc/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
