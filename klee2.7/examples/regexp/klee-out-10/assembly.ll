...
entry:
  ...
  %re = alloca [7 x i8]                           ; <[7 x i8]*> [#uses=3]
  %"alloca point" = bitcast i32 0 to i32          ; <i32> [#uses=0]
  ...
  %1 = getelementptr inbounds [7 x i8]* %re, i32 0, i32 6, !dbg !39 ; <i8*> [#uses=1]
  %2 = load i8* %1, align 1, !dbg !39             ; <i8> [#uses=1]
  %3 = icmp eq i8 %2, 0, !dbg !39                 ; <i1> [#uses=1]
  %4 = zext i1 %3 to i32, !dbg !39                ; <i32> [#uses=1]
  call void @klee_assume(i32 %4) nounwind, !dbg !39
  %re2 = bitcast [7 x i8]* %re to i8*, !dbg !40   ; <i8*> [#uses=1]
  %5 = call i32 @match(i8* %re2, i8* getelementptr inbounds ([6 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !40 ; <i32> [#uses=0]
  store i32 0, i32* %0, align 4, !dbg !41
  %6 = load i32* %0, align 4, !dbg !41            ; <i32> [#uses=1]
  store i32 %6, i32* %retval, align 4, !dbg !41
  %retval3 = load i32* %retval, !dbg !41          ; <i32> [#uses=1]
  ret i32 %retval3, !dbg !41
}
...
!2 = metadata !{i32 458769, i32 0, i32 1, metadata !"Regexp.c", metadata !"/home/wei/Documents/code/klee2.7/klee/examples/regexp/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_compil
...
!39 = metadata !{i32 58, i32 0, metadata !35, null}
!40 = metadata !{i32 60, i32 0, metadata !35, null}
!41 = metadata !{i32 62, i32 0, metadata !35, null}
