...
entry:
  ...
  %2 = load i8* %1, align 1, !dbg !39             ; <i8> [#uses=0]
  %re2 = bitcast [7 x i8]* %re to i8*, !dbg !40   ; <i8*> [#uses=1]
  %3 = call i32 @match(i8* %re2, i8* getelementptr inbounds ([6 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !40 ; <i32> [#uses=0]
  store i32 0, i32* %0, align 4, !dbg !41
  %4 = load i32* %0, align 4, !dbg !41            ; <i32> [#uses=1]
  store i32 %4, i32* %retval, align 4, !dbg !41
